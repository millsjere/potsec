...
const CourseItem = ({ course, onRemove, showAction = true }: Props) => {
    ...
    return (
        <Stack direction={'row'} p={1} px={1.5} mb={2} gap={1.5} alignItems={'center'} sx={{ border: 1, borderColor: 'divider', borderRadius: '8px' }}>
            ...
            {showAction && <IconButton onClick={onRemove} sx={{ bgcolor: '#f7f7f7', ml: 'auto', ':hover': { bgcolor: 'red', color: '#fff' } }}><Delete01Icon size={18} /></IconButton>}
        </Stack>
    )
}
